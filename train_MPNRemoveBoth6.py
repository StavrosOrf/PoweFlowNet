...
from networks.MPNRemoveBoth import MPN, MPN_simplenet
...
def main():
    ...
    # Step 1: Load data
    trainset = PowerFlowData(root=data_dir, case='6470rte', split=[.5, .2, .3], task='train')
    valset = PowerFlowData(root=data_dir, case='6470rte', split=[.5, .2, .3], task='val')
    ...
    if args.save:
        ...
        print("Testing on test data (case 118)...")
