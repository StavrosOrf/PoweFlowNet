...
from networks.GaussSeidelPooling import GraphTransformerWithPooling
...
def main():
    ...
    node_in_dim, _, _ = trainset.get_data_dimensions()
    model = GraphTransformerWithPooling(input_dim=node_in_dim,
                               hidden_dim=hidden_dim,
                               output_dim=output_dim,
                               num_layers=n_gnn_layers,
                               dropout_rate=dropout_rate,
                               num_pool_layers=2).to(device)
